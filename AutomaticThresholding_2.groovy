...
https://github.com/yau-lim/QuPath-Auto-Threshold/blob/main/autoThreshold.groovy
*/

/* PARAMETERS */
String channel = "DAPI" // "HTX", "DAB", "Residual" for BF ; use channel name for FL ; "Average":Mean of all channels for BF/FL
double thresholdDownsample = 1 // 1:Full, 2:Very high, 4:High, 8:Moderate, 16:Low, 32:Very low, 64:Extremely low
def threshold = "RenyiEntropy" // Input threshold value for fixed threshold. Use the following for auto threshold: "Default", "Huang", "Intermodes", "IsoData", "IJ_IsoData", "Li", "MaxEntropy", "Mean", "MinError", "Minimum", "Moments", "Otsu", "Percentile", "RenyiEntropy", "Shanbhag", "Triangle", "Yen"
...
double minArea = 10 // Minimum area for annotations to be created
double minHoleArea = 0 // Minimum area for holes in annotations to be created
String classifierObjectOptions = "SPLIT" // "SPLIT,DELETE_EXISTING,INCLUDE_IGNORED,SELECT_NEW"
